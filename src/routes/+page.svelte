<div class="flex flex-col items-center">
    ...
    <form class="w-1/2 flex flex-col items-center" method="GET" action="/search">
        <label class="font-serif font-normal text-xl text-white py-8" for="query">
        ...
        <div class="w-full flex justify-center">
            ...
            <input class="rounded-e-full w-24 bg-red-400 text-white hover:bg-white hover:text-red-400 cursor-pointer shadow-md" type="submit" value="Search"/>
        </div>
    </form>
</div>